...
public:
  ...
  MorphoMesh(const Eigen::MatrixXd& V, const Eigen::MatrixXd& P, const Eigen::MatrixXi& F,double _E,double _nu);
...
void ComputeElasticEnergy(geometrycentral::surface::IntrinsicGeometryInterface& geometry,
  ...
  Eigen::VectorXd lambda_s;
  Eigen::VectorXd lambda_r;
  Eigen::VectorXd lambda_t;
  Eigen::VectorXd lambda_a;

  Eigen::VectorXd kappa_s;
  Eigen::VectorXd kappa_r;
  Eigen::VectorXd kappa_t;
  Eigen::VectorXd kappa_a;


  Eigen::VectorXd lambda_diff;
  Eigen::VectorXd kappa_diff;
